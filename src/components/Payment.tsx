...
import { ArrowLeft, Shield, CreditCard, Check, Globe } from 'lucide-react';
...
export function Payment() {
  const { state, navigateToGenerator, completePayment } = useApp();
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Pack de 10 phrases d'accroche</span>
            ...
            {state.generationRequest && (
              <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                <div className="text-sm text-gray-600 mb-1">Votre concept :</div>
                <div className="text-sm font-medium text-gray-900 mb-2">
                  {state.generationRequest.concept}
                </div>
                <div className="flex items-center justify-between mb-2">
                  <div>
                    <div className="text-sm text-gray-600 mb-1">Ton sélectionné :</div>
                    <div className="text-sm font-medium text-gray-900 capitalize">
                      {state.generationRequest.tone}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-600 mb-1">Langue :</div>
                    <div className="flex items-center space-x-2">
          ...
          <button
            ...
            disabled={isProcessing}
            className={`w-full flex items-center justify-center space-x-3 py-4 rounded-xl text-lg font-semibold transition-all ${
              isProcessing
