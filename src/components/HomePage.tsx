      ...
      <main className="container mx-auto px-4 py-12">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <button
            ...
            className="group inline-flex items-center space-x-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-200 transform hover:scale-105"
          >
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <blockquote className="text-lg font-semibold text-gray-900 leading-relaxed">
                      "{example.hookline}"
                    </blockquote>
                  </div>
                </div>
